...
// NOTE: upstream MagicCard reads next-themes' useTheme() to pick the orb's
// blend mode. This app is dark-only (no theme toggle anywhere), so that
// dependency is dropped and isDarkTheme is just a constant.
